...
This folder contains detailed documentation intended for AI assistants working on this project.
...
1. Read `CLAUDE.md` in project root for overview
2. Check relevant doc here for implementation details
